    ...
    return (
      <div className="p-6 max-w-2xl mx-auto text-center">
        ...
        <div className="flex gap-3">
          ...
          <Button onClick={() => { onComplete({ score, total: questions.length }) }} className="flex-1 bg-gradient-to-r from-blue-500 to-cyan-500 text-white border-0 rounded-xl gap-2">
